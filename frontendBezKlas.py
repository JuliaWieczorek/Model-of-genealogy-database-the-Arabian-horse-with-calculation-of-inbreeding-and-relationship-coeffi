...
def imbred():
    ...
    h="Wspołczynnik Inbredu dla osobnika x, \n" \
      "został oszacowany na poziomie y.\n"
...
def pokrewienstwo():
    ...
    pok = "Wspólczynnik pokrewieństwa dla osobników:\n" \
          "x oraz y \n" \
          "wynosi: ???"

    # Przyciski
    B1 = Button(F2, text='Oblicz średni wspólczynnik pokrewieństwa',command=wynikpokre).grid(column=0, row=8, columnspan=3)
