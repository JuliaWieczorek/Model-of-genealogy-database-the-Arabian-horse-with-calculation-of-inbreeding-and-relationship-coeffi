...
def pokrewienstwo():
    ...
    def pokrewienstwo():
        ...
        X = (FFFF / f)
        wo ="Współczynnik pokrewieństwa dla tych osobników wynosi: %i" % X
    ...
    B2 = Button(F2, text='Oblicz współczynnik pokrewieństwa', command=pokrewienstwo).grid(column=0, row=8, columnspan=3)
...
def avgpokrewienstwa():
    ...
    def sredni_wspolczynnik_pokrewienstwa():
        ...
        length = len(all)
        MK = suma/length
        mk = "Średni współczynnik pokrewieństwa dla wybranego osobnika wynosi %i" % MK
    ...
    pok = "Średni współczynnik pokrewieństwa\n" \
          ...
          "Hodowca: {}\n" \
          "\n" \
          "Średni współczynnik pokrewieństwa dla tego osobnika wynosi: {}\n"
