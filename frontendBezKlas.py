...
def inbred():
    ...
    # Przyciski
    B1_wsimb = Button(F1, text='Oblicz współczynnik inbredu', command=wynikInbred).grid(column=0, row=10, columnspan=3)
...
class NoteBook(Frame):
    def __init__(self, master):
        ...
        oblicz.add_command(label="Współczynnik inbredu", command=inbred)
...
class Hodowcy(Frame):
    ...
    def __init__(self, master):
        ...
        self.treeH.grid(row=4, column=0, columnspan=2)
        self.treeH.heading('#0', text='Imię', anchor=W)
