...
#133 - babcia to tez matka (ZULA)
    def data_entry_relation(self):
        ...
        self.relacje1 = [(24, 22), (24, 23), (22, 19), (22, 20), (23, 21), (23, 20), (19, 13), (19, 14), (20, 15),
                         (20, 16), (21, 17), (21, 18), (13, 1), (13, 2), (14, 3), (14, 4), (15, 5), (15, 6), (17, 9),
                         (17, 10), (18, 11), (18, 12), (16, 7), (16, 8), (55, 53), (55, 54), (53, 49), (53, 50),
                         (54, 51), (54, 52), (49, 41), (49, 42), (50, 43), (50, 44), (51, 45), (51, 46), (52, 47),
                         (52, 48), (41, 25), (41, 26), (42, 27), (42, 28), (43, 29), (43, 30), (44, 31), (44, 32),
                         (45, 33), (45, 34), (46, 35), (46, 36), (47, 37), (47, 38), (48, 39), (48, 40), (75, 73),
                         (75, 74), (73, 69), (73, 70), (74, 71), (74, 72), (69, 64), (69, 65), (70, 66), (70, 67),
                         (71, 68), (71, 50), (72, 53), (72, 54), (64, 56), (64, 36), (65, 57), (65, 36), (66, 58),
                         (66, 52), (67, 59), (67, 60), (68, 61), (68, 62), (106, 104), (106, 105), (104, 100), (104, 101),
                         (105, 102), (105, 103), (100, 92), (100, 93), (101, 94), (101, 95), (102, 155), (102, 97),
                         (103, 98), (103, 99), (92, 76), (92, 77), (94, 111), (94, 81), (95, 82), (95, 83), (96, 149),
                         (96, 150), (97, 86), (97, 87), (98, 88), (98, 89), (99, 136), (99, 91), (134, 132), (134, 133),
                         (132, 129), (132, 130), (133, 127), (133, 131), (129, 123), (129, 124),  (130, 125), (130, 126),
                         (127, 119), (127, 120), (131, 127), (131, 128), (123, 107), (123, 108), (124, 109), (124, 110),
                         (125, 80), (125, 89), (126, 113), (126, 114), (119, 115), (119, 116), (120, 117), (120, 118),
                         (128, 121), (128, 122), (160, 158), (160, 159), (158, 96), (158, 97), (159, 157), (159, 114),
                         (157, 152), (157, 153), (114, 138), (114, 154), (84, 107), (84, 135), (150, 90), (150, 137),
                         (86, 138), (86, 139), (151, 140), (151, 141), (152, 142), (152, 143), (153, 121), (153, 144),
                         (138, 145), (138, 146), (154, 147), (154, 148)]
        self.relacje = [(1, 13), (2, 13), (3, 14), (4, 14), (5, 15), (6, 15), (7, 16), (8, 16), (9, 17), (10, 17),
                        (11, 18), (12, 18), (13, 19), (6, 19), (15, 20), (16, 20), (17, 21), (18, 21), (22, 19),
                        (22, 20), (21, 23), (20, 23), (24, 22), (24, 23), (25, 41), (26, 41), (27, 42), (28, 42),
    ...
    def data_entry_individual(self):
        ...
        self.osobniki = [(1, 'KARO', 'samiec', 2, 1), (2, 'KONY', 'samica', 2, 2), (3, 'FERRO', 'samiec', 2, 3),
                         ...
                         (9, 'ZIK', 'samiec', 2, 3), (10, 'CEDA', 'samica', 2, 2),
                         (11, 'BATT', 'samiec', 2, 1), (12, 'BETY', 'samica', 2, 2), (13, 'CARO', 'samiec', 2, 3),
                         (14, 'ISA', 'samica', 2, 1), (15, 'BAZI', 'samiec', 2, 1),
                         (16, 'DISTEL', 'samica', 2, 3), (17, 'CEKIN', 'samiec', 2, 1),
                         (18, 'ALI', 'samica', 2, 2),
                         (19, 'GUSTEL', 'samiec', 2, 3), (20, 'EMMA', 'samica', 2, 1),
                         (21, 'KARON', 'samiec', 2, 1), (22, 'Fido', 'samiec', 2, 2), (23, 'ANJA', 'samica', 2, 3),
                         (24, 'Gorky', 'samiec', 2, 2), (25, 'ALF', 'samiec', 2, 1),
                         (26, 'HELLA', 'samica', 2, 2), (27, 'MERKO', 'samiec', 2, 3),
                         (28, 'BIRKA', 'samica', 2, 3),
                         ...
                         (39, 'ALDO', 'samiec', 2, 3), (40, 'JASNA', 'samica', 2, 2),
                         (41, 'HEIFER', 'samiec', 2, 1), (42, 'BONITA', 'samica', 2, 2),
                         (43, 'ANDERL', 'samiec', 2, 3), (44, 'CHECKY', 'samica', 2, 1), (45, 'HARALD', 'samiec', 2, 2),
                         (46, 'DOSSI', 'samiec', 2, 3), (47, 'BOSKO', 'samica', 2, 1),
                         (48, 'BISTRA', 'samiec', 2, 2), (49, 'BALDER', 'samica', 2, 3),
                         (50, 'AGDA', 'samiec', 2, 1),
                         ...
                         (61, 'HASAN', 'samiec', 2, 2), (62, 'AINAVALMIS', 'samica', 2, 3),
                         (63, 'NDERL', 'samiec', 2, 3),
                         (64, 'ANDY', 'samiec', 2, 3), (65, 'BADCIBI', 'samica', 2, 2),
